...
else if ($_GET["purchID"] != $_SESSION['purchID'] ) {
	$ErrorMessage = "Request for           shop.php ERROR 2.008 - Mismatch between PHP Server-Session-Parameter 'purchID'='".$_SESSION['purchID']."' and URL Parameter 'purchID'='".$_GET["purchID"]."'";
}
else {	
...
echo 	'<tr>';
echo 		'<form action="cart.php?sessionKey='.$sessionKey.'&pageID='.$pageID.'&purchID='.$purchID.'" method="post">';
echo 		'<td>TBD</td>';
echo 		'<td>LuP Basis Package</td>';
echo 		'<td>200000 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID1.'" value="'.$Qtty1.'"></td>';
echo 		'<td>';
...
echo 		'<td>Cookies</td>';
echo		'<td>0.49 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID2.'" value="'.$Qtty2.'"></td>';
echo 		'<td>';
...
echo		'<td>49.99 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID3.'" value="'.$Qtty3.'"></td>';
echo 		'<td>';
...
echo 		'<td>299,99 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID4.'" value="'.$Qtty4.'"></td>';
echo 		'<td>';
...
echo 		'<td>14,99 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID5.'" value="'.$Qtty5.'"></td>';
echo 		'<td>';
...
echo 		'<td>49,99 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID6.'" value="'.$Qtty6.'"></td>';
echo 		'<td>';
...
echo 		'<td>6,66 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID7.'" value="'.$Qtty7.'"></td>';
echo 		'<td>';
...
echo 		'<td>2,99 $</td>';
echo 		'<td><input type="text" name="ct1_field27ID'.$hiddenID8.'" value="'.$Qtty8.'"></td>';
echo 		'<td>';
