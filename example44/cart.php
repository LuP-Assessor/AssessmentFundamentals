...
if (!isset($_POST['ct1_field27ID'.$hiddenID1]) && !isset($_POST['ct1_field27ID'.$hiddenID2]) && 
    !isset($_POST['ct1_field27ID'.$hiddenID3]) && !isset($_POST['ct1_field27ID'.$hiddenID4]) && 
	!isset($_POST['ct1_field27ID'.$hiddenID5]) && !isset($_POST['ct1_field27ID'.$hiddenID6]) && 
	!isset($_POST['ct1_field27ID'.$hiddenID7]) && !isset($_POST['ct1_field27ID'.$hiddenID8]) ) {
...
if (isset($_POST['ct1_field27ID'.$hiddenID1]) && $_POST['ct1_field27ID'.$hiddenID1] == 0) {
	$ErrorMessage = "ERROR (3.009) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID1."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID1]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID2]) && $_POST['ct1_field27ID'.$hiddenID2] == 0 ) {
	$ErrorMessage = "ERROR (3.010) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID2."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID2]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID3]) && $_POST['ct1_field27ID'.$hiddenID3] == 0 ) {
	$ErrorMessage = "ERROR (3.011) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID3."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID3]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID4]) && $_POST['ct1_field27ID'.$hiddenID4] == 0 ) {
	$ErrorMessage = "ERROR (3.012) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID4."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID4]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID5]) && $_POST['ct1_field27ID'.$hiddenID5] == 0 ) {
	$ErrorMessage = "ERROR (3.013) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID5."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID5]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID6]) && $_POST['ct1_field27ID'.$hiddenID6] == 0 ) {
	$ErrorMessage = "ERROR (3.014) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID6."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID6]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID7]) && $_POST['ct1_field27ID'.$hiddenID7] == 0 ) {
	$ErrorMessage = "ERROR (3.015) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID7."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID7]."'";
}
if (isset($_POST['ct1_field27ID'.$hiddenID8]) && $_POST['ct1_field27ID'.$hiddenID8] == 0 ) {
	$ErrorMessage = "ERROR (3.016) Request for cart.php with POST Parameter 'ctl_field27ID".$hiddenID8."', Value is 0 or not an Integer:'".$_POST['ct1_field27ID'.$hiddenID8]."'";
}
...
if (isset($_POST['ct1_field27ID'.$hiddenID1])) {
	if (!isset($_SESSION['Qtty1'])) {$_SESSION['Qtty1'] = $_POST['ct1_field27ID'.$hiddenID1]; $SuccessMessage = $SuccessMessage."- Added LuP Basis Package, new amount: ". $_SESSION['Qtty1'];} 
	                           else {$_SESSION['Qtty1'] = $_POST['ct1_field27ID'.$hiddenID1]+$_SESSION['Qtty1']; $SuccessMessage = $SuccessMessage."- Added LuP Basis Package, new amount: ". $_SESSION['Qtty1'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID2])) {
	if (!isset($_SESSION['Qtty2'])) {$_SESSION['Qtty2'] = $_POST['ct1_field27ID'.$hiddenID2]; $SuccessMessage = $SuccessMessage."- Added Cookies, new amount: ". $_SESSION['Qtty2'];} 
	                           else {$_SESSION['Qtty2'] = $_POST['ct1_field27ID'.$hiddenID2]+$_SESSION['Qtty2']; $SuccessMessage = $SuccessMessage."- Added Cookies, new amount: ". $_SESSION['Qtty2'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID3])) {
	if (!isset($_SESSION['Qtty3'])) {$_SESSION['Qtty3'] = $_POST['ct1_field27ID'.$hiddenID3]; $SuccessMessage = $SuccessMessage."- Added managed LG, new amount: ". $_SESSION['Qtty3'];}
							   else {$_SESSION['Qtty3'] = $_POST['ct1_field27ID'.$hiddenID3]+$_SESSION['Qtty3']; $SuccessMessage = $SuccessMessage."- Added managed LG, new amount: ". $_SESSION['Qtty3'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID4])) {
	if (!isset($_SESSION['Qtty4'])) {$_SESSION['Qtty4'] = $_POST['ct1_field27ID'.$hiddenID4]; $SuccessMessage = $SuccessMessage."- Added 10 manged LG's, new amount: ". $_SESSION['Qtty4'];}
		                       else {$_SESSION['Qtty4'] = $_POST['ct1_field27ID'.$hiddenID4]+$_SESSION['Qtty4']; $SuccessMessage = $SuccessMessage."- Added 10 manged LG's, new amount: ". $_SESSION['Qtty4'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID5])) {
	if (!isset($_SESSION['Qtty5'])) {$_SESSION['Qtty5'] = $_POST['ct1_field27ID'.$hiddenID5]; $SuccessMessage = $SuccessMessage."- Added unmanged LG's, new amount: ". $_SESSION['Qtty5'];}
		                       else {$_SESSION['Qtty5'] = $_POST['ct1_field27ID'.$hiddenID5]+$_SESSION['Qtty5']; $SuccessMessage = $SuccessMessage."- Added unmanged LG's, new amount: ". $_SESSION['Qtty5'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID6])) {
	if (!isset($_SESSION['Qtty6'])) {$_SESSION['Qtty6'] = $_POST['ct1_field27ID'.$hiddenID6]; $SuccessMessage = $SuccessMessage."- Added 10 unmanged LG's, new amount: ". $_SESSION['Qtty6'];}
		                       else {$_SESSION['Qtty6'] = $_POST['ct1_field27ID'.$hiddenID6]+$_SESSION['Qtty6']; $SuccessMessage = $SuccessMessage."- Added 10 unmanged LG's, new amount: ". $_SESSION['Qtty6'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID7])) {
	if (!isset($_SESSION['Qtty7'])) {$_SESSION['Qtty7'] = $_POST['ct1_field27ID'.$hiddenID7]; $SuccessMessage = $SuccessMessage."- Added Coffee, new amount: ". $_SESSION['Qtty7'];}
		                       else {$_SESSION['Qtty7'] = $_POST['ct1_field27ID'.$hiddenID7]+$_SESSION['Qtty7']; $SuccessMessage = $SuccessMessage."- Added Coffee, new amount: ". $_SESSION['Qtty7'];} }
if (isset($_POST['ct1_field27ID'.$hiddenID8])) {
	if (!isset($_SESSION['Qtty8'])) {$_SESSION['Qtty8'] = $_POST['ct1_field27ID'.$hiddenID8]; $SuccessMessage = $SuccessMessage."- Added Energy Dring, new amount: ". $_SESSION['Qtty7'];}
		                       else {$_SESSION['Qtty8'] = $_POST['ct1_field27ID'.$hiddenID8]+$_SESSION['Qtty8']; $SuccessMessage = $SuccessMessage."- Added Energy Dring, new amount: ". $_SESSION['Qtty7'];} }
...
echo '<br><br><a href="shop.php?sessionKey='.$sessionKey.'&pageID='.$pageID.'&purchID='.$purchID.'">Continue shopping</a><br>';
