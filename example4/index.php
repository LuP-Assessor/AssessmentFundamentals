...
if ($ErrorMessage=="") {
	$SuccessMessage = date("Y-m-d H:i:s"). substr((string)microtime(), 1, 8)." ".$ip." Request for          index.php Successfull - 'sessionKey'='".$sessionKey."', 'ClientBrowser'='".$ClientBrowser."'";
...
echo '<div id="" class="Div_DataArea Div_deactive" style="top:120px;">';
	...
	echo "<b>Pre Runtime settings for Exercise1:</b><br>
