...
// ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Checking all resquest mistakes between client and example 0 page3.php:

// Check for wrong HPPT Request type (This page have to be requested by GET Method)
if ($_SERVER['REQUEST_METHOD'] !== 'GET') {
    $ErrorMessage = "ERROR (2.001) Request for page3.php with wrong HTML Method: '".$_SERVER['REQUEST_METHOD']."', should be 'GET', ClientBrowser: ".$ClientBrowser;
}

// If no error was found in previous checks -> Write Successfull Message to Log
if ($ErrorMessage=="") {
	$SuccessMessage = date("Y-m-d H:i:s")." ".$ip." Request for          page3.php Successfull - ClientBrowser: ".$ClientBrowser;
...
?>
	...
	<a href="page1.php">Link to restart procedure from page 1</a>
